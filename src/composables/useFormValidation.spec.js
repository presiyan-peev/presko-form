...
describe('useFormValidation', () => {
  ...
  describe('required rule', () => {
    ...
    it('should be invalid if value is empty or whitespace', () => {
      ...
      expect(formValidation.formFieldsErrorMessages.name).toBe('Field Name is required.');
  ...
  describe('email rule', () => {
    ...
    it('should be invalid for incorrect email format', () => {
      ...
      expect(formValidation.formFieldsErrorMessages.email).toBe('Field Email is not a valid email address.');
    });
  ...
  describe('domain rule', () => {
    ...
    it('should be invalid for incorrect domain format and use custom message', () => {
      ...
      expect(formValidation.formFieldsErrorMessages.website).toBe('Invalid domain format.');
    });
  ...
  describe('ipv4 rule', () => {
    ...
    it('should be invalid for incorrect ipv4 format', () => {
      ...
      expect(formValidation.formFieldsErrorMessages.ipv4Field).toBe('Field IPv4 Field is not a valid IPv4 address.');
    });
  ...
  describe('ipv6 rule', () => {
    ...
    it('should be invalid for incorrect ipv6 format', () => {
      ...
      expect(formValidation.formFieldsErrorMessages.ipv6Field).toBe('Field IPv6 Field is not a valid IPv6 address.');
    });
    it('should be valid for correct ipv6 format', () => {
      formValidation.validateField(field, '2001:0db8:85a3:0000:0000:8a2e:0370:7334');
  ...
  describe('custom validator', () => {
    ...
    it('should be invalid if custom validation fails', () => {
      ...
      expect(formValidation.formFieldsErrorMessages.custom).toBe('Must be "valid".');
    });
  ...
  describe('regex rule', () => {
    ...
    it('should be invalid if value does not match regex', () => {
      ...
      // Default message for regex is a bit generic, this might change based on implementation details
    ...
    it('should validate all fields based on provided form data', () => {
      ...
      fields.forEach(fieldObj => {
        if (currentFormData.hasOwnProperty(fieldObj.propertyName)) {
          formValidation.validateField(fieldObj, currentFormData[fieldObj.propertyName]);
        }
      });
      ...
      const isFormInvalid = Object.values(formValidation.formFieldsValidity).includes(false);
  ...
  describe('multiple rules', () => {
    ...
    it('should fail if first rule (required) is not met', () => {
      ...
      expect(formValidation.formFieldsErrorMessages.username).toBe('Field Username is required.');
    });
    ...
    it('should fail if second rule (alphanumeric) is not met, even if first is met', () => {
      ...
      expect(formValidation.formFieldsErrorMessages.username).toContain('Field Username is not valid.');
    });
